(function () {
    ...
    function HomeView() {
        ...
        function loadReorderModal(playlist) {
            ...
            modal_close.title = "Chiudi";
            modal_close.className = "modal-close";
            modal_close.setAttribute('aria-label', 'Chiudi');
            // Use an inline X SVG icon for the close button (keeps compact UI and accessibility)
            modal_close.innerHTML = '<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor" aria-hidden="true">\n                <path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"/>\n            </svg>';
